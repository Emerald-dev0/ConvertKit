  ...
  return (
    <main className="min-h-screen flex flex-col items-center py-24 px-6 md:px-12">
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl mb-6 text-foreground font-display font-bold">
          The engine for <br />
          <span className="text-primary italic">every</span> conversion.
        </h1>
        <p className="text-muted text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Experience the ConvertKit infrastructure. Upload a file, choose your format,
          and see the core engine in action. No accounts, no latency.
        </p>
      </motion.div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-2 flex-wrap">
                {['jpg', 'png', 'webp', 'txt', 'json', 'html'].map((fmt) => (
                  <button
                    key={fmt}
                    type="button"
